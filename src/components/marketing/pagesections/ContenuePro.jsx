  ...
  return (
    <div className="grid  lg:grid-cols-3 lg:gap-x-1 lg:mt-10 lg:mb-20 ">
      <div className="h-full w-full  ">
        ...
        <div className="flex justify-center items-center flex-col px-5 pt-35 lg:pt-10 sm:pt-75 md:pt-100 xl:pt-23 2xl:pt-30 pb-10 min-[600px]:pt-45  ">
      ...
      <div className="h-full  w-full">
        ...
        <div className="flex justify-center items-center flex-col px-5 pt-35 min-[600px]:pt-45 lg:pt-10 sm:pt-75 md:pt-100 xl:pt-23 2xl:pt-30 pb-10 ">
